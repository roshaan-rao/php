...
function send_email($email,$html,$subject){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="foodchef.official@gmail.com";
	$mail->Password="foodchef24/7";
	$mail->setFrom("foodchef.official@gmail.com");
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                ...
                <img src="https://github.com/MRoshaanJamshaid/foodChefLogo/blob/main/logo.png?raw=true" width="110" height="60"/>
              </a>
              </td>
            </tr>
            <!-- Email Body -->
            <tr>
              ...
              <strong>Order ID:</strong> '.$order_id.'
                        ...
                        <p>Cheers,
                          <br><span color="red">foodChef</span></p>
                        <!-- Sub copy -->
