  ...
  <div class="page-header">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card px-2">
                  <div class="card-body">
				  <h3 class="page-title text-center text-primary">foodChef Invoice </h3>
                    <div class="container-fluid">
                      <h3 class="text-left my-5">Order ID&nbsp;&nbsp;<?php echo $id?></h3>
                      <hr>
                    </div>
                    <div class="container-fluid d-flex justify-content-between">
                      <div class="col-lg-3 pl-0">
                        <p class="mt-5 mb-2"><b>foodChef</b></p>
                        <p>Shop Address</p>
                      </div>
                      <div class="col-lg-3 pr-0">
                        <p class="mt-5 mb-2 text-right"><b>Customer Details</b></p>
                        <p class="text-right">
