...
?>
  <div class="card">
            <div class="card-body">
              <h1 class="grid_title text-primary">Delivery Boy Information</h1>
			  <a href="manage_delivery_boy.php" class="add_link"><button type="button" class="btn btn-primary">Add Delivery Boy</button></a>
